...
public class SelectionMenu {
    ...
    public void letsGo() {
        ...
        Gift gift = director.buildGift();
        System.out.println(gift);
        residualCapacity = gift.getBox().getWeight() - gift.getWeight();
        gift = director.complementGift();
        System.out.println(gift);
    ...
    private static void addAllCandies(ArrayList<Candy> candies) {
        candies.addAll(Arrays.asList(Candy.values()));
        residualCapacity -= Arrays.stream(Candy.values()).mapToInt(Candy::getWeight).sum();
        addCandiesByYourself(candies);
    }
